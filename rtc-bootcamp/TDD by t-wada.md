...
# **テストは仕様なので、受け付ける値の範囲をテストケースを追加して、どんな値なら受け付けて受けつかないのようなテストコードを書く**
...
使う側に意図を伝えるテストケースを書く。また変な誤解を生むようなテスとはかかかない

- **副作用があるならそのようなテストを書けばよいし、素直な実装なら素直にテストをかく**


### テストがすでにないシステムを書くときに困ったら

Book: レガシーコード改善ガイド
Book: レガシーソフトウェア改善ガイド
